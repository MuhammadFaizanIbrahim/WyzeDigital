...
const nav = ["Home", "About", "Services", "Portfolio", "Contact Us"];
...
export default function Header() {
        ...
        return (
          <a
            ...
            onClick={(e) => {
              ...
              onClick?.(); // ✅ don't crash on desktop
  ...
  return (
    <header className="w-full header-shell">
      <div className="mx-auto flex items-center justify-between px-75 py-9 md:px-15 lg:px-20 xl:px-35 2xl:px-75 header-row">
        ...
        <div className="flex items-center header-logo">
          <img
            src="/images/WyzeLogo1.png"
            alt="Logo"
            className="block h-20 w-[177px] object-contain cursor-pointer"
          />
        </div>
